  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Bem vindo estranho</h5>
      ...
      <label for="sel1">Vamos, escolha uma de minhas mercadorias</label>
        <div class="form-group">
          <select class="form-control" data-toggle="tooltip" name="name_item" id="sel1" required>
          <option><p><p></option>
          <?php foreach ($itens as $it){ ?> 
            <option value='<?= $it->id; ?>' title="Please choose one"><?= $it->nome_item; ?> Custo:<?= $it->custo_xp; ?></option>
          <?php }?>
          </select>
        </div>
        <br>
